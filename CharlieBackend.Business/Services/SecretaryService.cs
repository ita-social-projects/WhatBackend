...
namespace CharlieBackend.Business.Services
{
    public class SecretaryService : ISecretaryService
    {
        ...
        public async Task<Result<SecretaryDto>> UpdateSecretaryAsync(UpdateSecretaryDto secretaryDto)
        {
            try
            {
                var foundSecretary = await _unitOfWork.SecretaryRepository.GetByIdAsync(secretaryDto.Id);
            ...
            catch
            {
                ...
                return Result<SecretaryDto>.Error(ErrorCode.InternalServerError, "Error while updating secretary"); ;
            }
        }
