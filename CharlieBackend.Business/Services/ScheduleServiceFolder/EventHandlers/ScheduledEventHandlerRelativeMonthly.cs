...
namespace CharlieBackend.Business.Services.ScheduleServiceFolder
{
    public class ScheduledEventHandlerRelativeMonthly : ScheduledEventHandlerBase
    {
        ...
        private static DateTime GetFirstDayOfWeekInTheMonth(int year, int month, DayOfWeek dayOfWeek)
        {
        ...
        private static DateTime GetNthDayOfWeekInTheMonth(int year, int month, DayOfWeek dayOfWeek, WeekIndex n)
        {
