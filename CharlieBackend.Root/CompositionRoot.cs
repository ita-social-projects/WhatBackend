...
namespace CharlieBackend.Root
{
    public class CompositionRoot
    {
        ...
        public static void InjectDependencies(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IGroupFileImporter, GroupFileImporter>();
            services.AddScoped<IStudentFileImporter, StudentFileImporter>();
            services.AddScoped<IThemeFileImporter, ThemeFileImporter>();
            #endregion
        }
    }
}
